...
namespace projekfix
{
    public partial class VarianProdukkaryawan : Form
    {
        distroshopDataContext dt = new distroshopDataContext();
        private pengguna _akun;

        public VarianProdukkaryawan(pengguna akun)
        {
            InitializeComponent();
            _akun = akun;
            ...
            // Pastikan Anda memiliki kontrol bernama lblAdminNama di form Anda
            lblAdminNama.Text = $"Selamat datang, {_akun.NamaLengkap}";
        }
        ...
        private void dgvVarian_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                cmbIdProduk.Text = row.Cells["NamaProduk"].Value.ToString(); // Set berdasarkan nama yang tampil
        ...
        private void button3_Click(object sender, EventArgs e) // Input Pesanan
        {
        ...
        private void button4_Click(object sender, EventArgs e) // Input Pelanggan
        {
        ...
        private void VarianProdukkaryawan_Load(object sender, EventArgs e)
        {
